...
[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-Try_Now-success?style=for-the-badge)](https://gsonovb.github.io/endfield-calc)
...
### Try Online
Visit **[https://gsonovb.github.io/endfield-calc](https://gsonovb.github.io/endfield-calc)**

### Local Development
```bash
git clone https://github.com/gsonovb/endfield-calc.git
cd endfield-calc
pnpm install
pnpm run dev
```
